...
// Build step 3: Styles processing
gulp.task('build-styles', () => {
  return gulp
    ...
    .pipe(sourcemaps.write())
    .pipe(postcss([
      // Autoprefixer browserlist settings are in "package.json"
...
// Build step 6: JavaScript bundle (Webpack) + transfer
